...
public class RestMethod {
    ...
    public final static String JSON_TYPE = "application/json";  //MIME types

    public final static int SERVICE_DURATION = 5000;  //Timeouts
    ...
    private URL registerURL() {
        try {
            return new URL("http", Settings.getServerUri(context), 8080, "chat/" + Settings.getClientId(context));
//            return new URL("http", "chengberendembp.fios-router.home", 8080, "chat/" + Settings.getClientId(context));
        } catch (Exception e) {
            return null;  // TODO
        }
    }
    ...
    private URL postMessageURL() {
        try {
            return new URL("http", Settings.getServerUri(context), 8080, "chat/" +Settings.getClientId(context)+ "/messages");
//            return new URL("http", "chengberendembp.fios-router.home", 8080, "chat/" + Settings.getClientId(context) + "/messages");
        } catch (Exception e) {
            return null;  // TODO
        }
    }
    ...
    private Response executeRequest(RegisterRequest request) throws SocketTimeoutException, IOException {
        return executeRequest(PUT_METHOD, request);
    }

    private Response executeRequest(PostMessageRequest request) throws SocketTimeoutException, IOException {
    ...
    private Response executeRequest(String method, Request request) throws SocketTimeoutException, IOException {
        ...
        Response response = request.getResponse(connection, rd);  //get responseCode & responseMessage
