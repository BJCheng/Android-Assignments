...
//    protected void executeQuery(Uri uri, String[] projection, String selection, String[] selectionArgs, QueryBuilder.IQueryListener<T> listener) {
//        QueryBuilder.executeQuery(tag, (Activity) context, uri, loaderID, creator, listener, projection, selection, selectionArgs, creator, listener);
//    }
